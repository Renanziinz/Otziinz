			...
			local msg = ""
			    if b.pokeName == "none" then -- held items Y-Ghost
				   ...
				   doSendMagicEffect(getThingPos(cid), 13)
					...
					if getItemAttribute(item2.uid, "yHeldItem") then doSendMsg(cid, "Este pokemon já possui o " .. heldName .. ".") return true end
					doItemSetAttribute(item2.uid, "yHeldItem",	a .. "|MEGA")
				    msg = "Paranbéns. Agora seu: "  .. nick .. " pode transforma-se em Mega " .. nick .. (b.megaID or "") .."."
				   doRemoveItem(item.uid, 1)
				   doSendMagicEffect(getThingPos(cid), 13)
end
					doSendMsg(cid, msg)
